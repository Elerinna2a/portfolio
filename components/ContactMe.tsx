    ...
    <div className="relative flex flex-col h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10">
        <h4 className="text-xl font-semibold text-center ">
          ...
          <span className="decoration-[#9C4498] underline">Lets talk.</span>
        </h4>
        <div className="space-y-5">
          <div className="flex items-center space-x-5 justify-center">
            <PhoneIcon className="text-[#9C4498] h-7 w-7 animate-pulse" />
            <p className="text-xl">1234567890</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#9C4498] h-7 w-7 animate-pulse" />
            <p className="text-xl">abellan.antony@gmail.com</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#9C4498] h-7 w-7 animate-pulse" />
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#9C4498] py-5 px-10 rounded-md text-black font-bold"
            >
              {" "}
              Submit{" "}
            </button>
